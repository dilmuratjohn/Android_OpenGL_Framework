...
class Actions {
    static class Translate {
        ...
        float startTime, endTime, originX, deltaX, originY, deltaY;
    ...
    static class Angle {
        ...
        float startTime, endTime, originAngle, deltaAngle;
    ...
    static class Tint {
        ...
        float startTime, endTime, originRed, originGreed, originBlue, deltaRed, deltaGreen, deltaBlue;
    ...
    static class Fade {
        ...
        float startTime, endTime, originAlpha, deltaAlpha;
