...
public class TextureHelper {
    ...
    static int create(Context context, int resourceId) {
        ...
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);	// set texture wrapping to GL_REPEAT (default wrapping method)
